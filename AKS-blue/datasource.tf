...
## C est un peu sale : à variabiliser proprement
data "azurerm_virtual_network" "Terra_aks_vnet" {
  name                = "aksvnet"
  resource_group_name = "RG-demostan-21"
}

## C est un peu sale : à variabiliser proprement
data "azurerm_subnet" "Terra_aks_subnet" {
  name                 = "backend"
